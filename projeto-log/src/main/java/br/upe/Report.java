...
public class Report {
    ...
    public void writeOs(ArrayList<LogData> logDataList) {
        ...
        lines.add("Windows, " + ((windows / total) * 100 + "\n"));
        lines.add("Macintosh, " + ((macintosh / total) * 100 + "\n"));
        lines.add("Ubuntu, " + ((ubuntu / total) * 100 + "\n"));
        lines.add("Fedora, " + ((fedora / total) * 100 + "\n"));
        lines.add("Mobile, " + ((mobile / total) * 100 + "\n"));
        lines.add("Others, " + ((others / total) * 100 + "\n"));
